...
- [0050](0050-a-genetic-search-mode-breeds-candidates-from-the-search-run.md) — genetic search breeds from the run's own history behind the existing CandidateGenerator seam
- [0051](0051-the-web-ui-adopts-an-exchange-terminal-visual-system-dark-gr.md) — the web UI adopts an exchange-terminal visual system: dark ground, one amber accent, dense data tables
